"""
Django settings for seppi_44713 project.
...
WSGI_APPLICATION = 'seppi_44713.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "seppi_44713 API",
    "DESCRIPTION": "API documentation for seppi_44713 App",
    "VERSION": "v1",
}
